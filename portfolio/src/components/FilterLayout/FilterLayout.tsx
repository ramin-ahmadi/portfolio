...
export const LAYOUTS = {
  ...
  All: {
    ...
    ModularSofa: { col: "1 / 5", row: "2 / 4" },
    BulbCard: { col: "1", row: "4" },
    DuolingoCard: { col: "2", row: "4" },
    Quote: { col: "3 / 5", row: "4" },
    DesignSystem: { col: "1 / 5", row: "5 / 7" },
    Rebrand: { col: "3", row: "8 /10" },
    Libra: { col: "4 / 5", row: "8 / 10" },
    QuoteUX: { col: "3 / 5", row: "7" },
  ...
  "About me": {
    ...
    Rebrand: { col: "3", row: "8/10", dim: true },
  ...
  Work: {
    ModularSofa: { col: "1 / 5", row: "1/3" },
    DesignSystem: { col: "1 / 5", row: "3/5" },
    Rebrand: { col: "3", row: "5 / 7" },
    Libra: { col: "4 / 5", row: "5 / 7" },
    Essity: { col: "1 / 3", row: "5 / 7" },
    AboutCard: { col: "1 / 3", row: "7", dim: true },
    GmailCard: { col: "3", row: "7", dim: true },
    LinkedinCard: { col: "4", row: "7", dim: true },
    BulbCard: { col: "1", row: "8", dim: true },
    DuolingoCard: { col: "2", row: "8", dim: true },
    Quote: { col: "3 / 5", row: "8", dim: true },
    QuoteUX: { col: "1 / 3", row: "9", dim: true },
    Strava: { col: "3", row: "9", dim: true },
    Books: { col: "4", row: "9", dim: true },
  },
...
export const MOBILE_LAYOUTS = {
  ...
  All: {
    ...
    ModularSofa: { col: "1 / 3", row: "3 / 5" },
    BulbCard: { col: "1", row: "5" },
    DuolingoCard: { col: "2", row: "5" },
    DesignSystem: { col: "1 / 3", row: "6 / 8" },
    Rebrand: { col: "1", row: "8 / 10" },
  ...
  "About me": {
    ...
    Rebrand: { col: "1", row: "11 / 13", dim: true },
